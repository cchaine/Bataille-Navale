 ...
 * @author cchaine
 *
 * @brief Classe définissant la première étape du programme
...
public class MenuState extends State {
	...
	public MenuState(StateManager stateManager) {
		...
		playButton = new TextButton(Display.width / 2, (int)buttonOffset, "jouer", "JOUER", new Color(0x68D16A), AssetLoader.junebug50);
		quitButton = new TextButton(Display.width / 2, (int)buttonOffset + 160, "quitter", "QUITTER", new Color(0xE72623), AssetLoader.junebug50);
		onePlayerButton = new TextButton(Display.width / 2, (int)buttonOffset, "joueur vs ordinateur", "JOUEUR VS ORDINATEUR", new Color(0x76FF78), AssetLoader.junebug50);
		twoPlayerButton = new TextButton(Display.width / 2, (int)buttonOffset, "joueur vs joueur", "JOUEUR VS JOUEUR", new Color(0x76FF78), AssetLoader.junebug50);
	}
	 ...
	 * 
	 * @details Met à jour l'état des boutons ainsi que la 
	 * position des vagues et du bateau
	 */
	public void update() {
		//Récupère la position du pointeur sur l'écran et y soustrait la position de la fenêtre sur l'écran pour avoir la position du pointeur sur la fenêtre
